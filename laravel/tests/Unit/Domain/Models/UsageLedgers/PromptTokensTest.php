...
{
    public function test_can_create_prompt_tokens_with_valid_value(): void
    {
        $tokens = new PromptTokens(1);

        $this->assertSame(1, $tokens->getValue());
    }

    public function test_can_create_prompt_tokens_with_zero(): void
    {
        $tokens = new PromptTokens(0);

        $this->assertSame(0, $tokens->getValue());
    }

    public function test_can_create_prompt_tokens_with_large_value(): void
    {
        $tokens = new PromptTokens(999999);
